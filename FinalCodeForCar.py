            ...
            if (ml-mr) != 0:
                ...
                if obstacles:
                    ...
                    for i in range(len(obstacles)):
                        ...
                        if(obstacles[i][1] + obstacles[i][3]/2 > y):
                            rx = (obstacles[i][1]+obstacles[i][3]/2-interr)/mr
                            lx = (obstacles[i][1]+obstacles[i][3]/2-interl)/ml
                            print("x: ", x, "y: ", y)
                            if(obstacles[i][0] < rx and obstacles[i][0] > lx):
